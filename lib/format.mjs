...
// Color is literal sign, not semantic "is this good or bad" judgment — an
// increase is always green, a decrease is always red, regardless of metric.
export function trendBadge(diffValue, { unit = "%", extra = "" } = {}) {
...
export const MODEL_LIFECYCLE_EVENTS = [
  {
    ...
    observation:
      "Anthropic announced that Claude Opus 4.1 retires on 28 October 2026.",
    likelyReason:
